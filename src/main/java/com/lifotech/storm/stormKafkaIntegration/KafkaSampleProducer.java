...
public class KafkaSampleProducer {
    ...
    public static void main(String[] args) {
        ...
        props.put("bootstrap.servers", "kafka1:9092, kafka1:9092, kafka1:9092");
        ...
        props.setProperty("value.serializer", org.apache.kafka.common.serialization.StringSerializer.class.getName());
       ...
       /* props.put("key.serializer",
        ...
        for (String word : METAMORPHOSIS_OPENING_PARA.split("\\s")) {
            ...
            ProducerRecord<String, String> data = new ProducerRecord<String, String>("masteringApacheStorm-stormKafkaIntegration",word, word);
            // Send the message
            producer.send(data);
        }
